...
{
    ClassDB::bind_method(D_METHOD("set_name", "name"), &Need::set_name);
    ClassDB::bind_method(D_METHOD("get_name"), &Need::get_name);

    ADD_PROPERTY(PropertyInfo(Variant::STRING, "name"), "set_name", "get_name");

    ClassDB::bind_method(D_METHOD("set_response", "curve"), &Need::set_response);
    ...
    ClassDB::bind_method(D_METHOD("set_attenuation_weight", "weight"), &Need::set_attenuation_weight);
    ...
    ClassDB::bind_method(D_METHOD("set_decay_time", "time"), &Need::set_decay_time);
    ...
    ClassDB::bind_method(D_METHOD("set_initial_value", "value"), &Need::set_initial_value);
